...
BOOL	CMagicItem::Draw ( int nMapX, int nMapY )
{
	switch(m_nMoment)
	{
	case 0: // Initialization Tme, from creation to start playing ...

//		g_objGameMap.AddTerrainMagicUnit();
		break;
	case 1: // Initialization Tme, from continuing to start playing ...

		break;
	case 2: // Initialization Tme, playing the end of
