...
//--------------------------------------------------------------
void CGameMap::ShowExp() //loveomg--------- EXP
{
	...
	{
		if(m_bShowExp)
			CMyBitmap::ShowString(posShow.x, posShow.y, 0xff01f546, g_objGameDataSet.GetStr(100138), "Italic", 18, true);
		return;
	}
	...
	if(m_bShowExp)
		CMyBitmap::ShowString(posShow.x, posShow.y, 0xff01f546, szRate, "Italic", 18, true);
	...
	if(m_bShowExp && m_dwShowExp > 0 && (::TimeGet() - m_dwTimeExpBegin) < 2000)
	{
		...
		CMyBitmap::ShowString(nShowX, posShow.y, 0xff01f546, szExp, "Italic", 18, true);
	}
}
//--------------------------------------------------------------
